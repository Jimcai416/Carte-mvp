...
Effective 26 July 2026 · Carte beta

Carte helps people understand restaurant menus. This policy explains the
limited data used to provide and improve the beta.

## Menu scans

When a user chooses to scan, the menu photo is sent securely to Carte's
Cloudflare-hosted service and then to Anthropic's commercial API for menu
recognition and translation. Carte does not save the menu photo in its own
...
stored locally on that device. To find representative dish images, Carte may
...
Carte creates a random installation identifier for abuse prevention, daily scan
...
Carte disables default personal information, screenshots, view hierarchy, and
...
Carte does not sell personal data, serve targeted advertising, or track users
...
device. Removing Carte deletes its local history and random identifier. UK and
